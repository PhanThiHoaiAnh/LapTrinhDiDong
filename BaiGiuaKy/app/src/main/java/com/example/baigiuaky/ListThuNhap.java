...
public class ListThuNhap extends AppCompatActivity {
    ...
    private com.example.baithuchanhgiuaky.AdapterThuNhap adtThu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adtThu = new com.example.baithuchanhgiuaky.AdapterThuNhap(ListThuNhap.this, R.layout.layout_item, arrList);
