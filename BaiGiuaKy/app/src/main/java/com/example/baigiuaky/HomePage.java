...
public class HomePage extends AppCompatActivity {
    ...
    public void openLogInPage() {
        Intent intent = new Intent(HomePage.this, com.example.baigiuaky.LogInPage.class);
    ...
    public void openListChiTieu() {
        Intent intent = new Intent(HomePage.this, com.example.baigiuaky.ListChiTieu.class);
        startActivity(intent);
    }

    public void openListThuNhap() {
        Intent intent = new Intent(HomePage.this, com.example.baigiuaky.ListThuNhap.class);
        startActivity(intent);
    }
}
