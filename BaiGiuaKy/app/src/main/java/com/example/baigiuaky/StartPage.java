...
public class StartPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void openLogInPage() {
            Intent intent = new Intent(StartPage.this, com.example.baithuchanhgiuaky.LogInPage.class);
            startActivity(intent);
        }

        public void openSignUpPage() {
            Intent intent = new Intent(StartPage.this, com.example.baithuchanhgiuaky.SignUpPage.class);
            startActivity(intent);
        }
}
